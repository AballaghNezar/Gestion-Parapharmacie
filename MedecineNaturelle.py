...
cursor.execute("SELECT Nom,Prix from Produit WHERE Categorie='Med Naturelle' ")
...
background_img = PhotoImage(file = f"backgroundMd.png")
background = canvas.create_image(
    591.5, 332.5,
    image=background_img)

img0 = PhotoImage(file = f"img0Md.png")
b0 = Button(
    image = img0,
    borderwidth = 0,
    highlightthickness = 0,
...
img1 = PhotoImage(file = f"img1Md.png")
b1 = Button(
    image = img1,
    borderwidth = 0,
    highlightthickness = 0,
