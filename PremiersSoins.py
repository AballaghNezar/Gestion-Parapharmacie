...
cursor.execute("SELECT Nom,Prix from Produit WHERE Categorie='Premiers Soins' ")
...
background_img = PhotoImage(file = f"backgroundPs.png")
background = canvas.create_image(
    591.5, 332.5,
    image=background_img)

img0 = PhotoImage(file = f"img0Ps.png")
b0 = Button(
    image = img0,
    borderwidth = 0,
    highlightthickness = 0,
...
img1 = PhotoImage(file = f"img1Ps.png")
b1 = Button(
    image = img1,
    borderwidth = 0,
    highlightthickness = 0,
