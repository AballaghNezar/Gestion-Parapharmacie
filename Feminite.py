...
cursor.execute("SELECT Nom,Prix from Produit WHERE Categorie='Feminite' ")
...
background_img = PhotoImage(file = f"backgroundFm.png")
background = canvas.create_image(
    591.5, 332.5,
    image=background_img)

img0 = PhotoImage(file = f"img0Fm.png")
b0 = Button(
    image = img0,
    borderwidth = 0,
    highlightthickness = 0,
...
img1 = PhotoImage(file = f"img1Fm.png")
b1 = Button(
    image = img1,
    borderwidth = 0,
    highlightthickness = 0,
